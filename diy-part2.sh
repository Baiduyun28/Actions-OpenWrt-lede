...
#rm -rf feeds/packages/transmission
#git clone https://github.com/transmission/transmission/ feeds/packages/transmission
#./scripts/feeds install -p feeds/packages/transmission
